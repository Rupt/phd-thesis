...
analysis.
\textit{Figures reproduced from the paper%
...
The $\twoljets$-strong search target strongly interacting supersymmetric effects in cases where their decays produce pairs
of charged leptons.
Like the RJR and electroweak parts, jets and invisible lightest supersymmetric
particles are also generated.

% mll, kinematic end point
...
% three exclusion plots

\TODO{data driven backgrounds: flavour symmetry, photon method z+jets, 40GeV cut}
