...
reproduce this effect outside the \histfitter-\roofit ecosystem, but would
not be surprised if similar complications with the test statistic distribution
played a part.
...
% lack: resources to study, methods to analyse
% cost: delays, opportunity cost
% higher quality result by simpler more robust design published sooner
% accelerate science by doing it now, not in two years.
