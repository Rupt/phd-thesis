...
the PDG rounding scheme~\cite{pdg2020review}.%
}
...
Strongly supersymmetric particles, the super-partners of quarks and gluons, would
be produced at much larger cross-sections than their electroweak cousins at the
LHC.
...
The point to listing these requirements is to show trigger activations are
non-trivial.
...
The control region \crvz\ occupies the $\mjj$ sideband to
SR-Int and VR-Int.
