...
\end{subfigure}
\caption[
Feynman diagrams for the Standard Model background processes
]{%
Feynman diagrams for the Standard Model background processes of important
background contributions in the $\twoljets$-electroweak search.
...
For example, the corresponding capture rate it $0.64\%$ for the C1N2 model with
