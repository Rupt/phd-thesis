...
As in the $\twoljets$-strong search, each signal region is chosen from an
expected sensitivity for each signal point.
These regions and their resulting exclusion contours are displayed in
...
The rightmost bin incluedes overflow.
\\[0.5em]
...
% run1
\TODO{run 1?}
\cite{atlas_2l_SUSY_2013_11}

\TODO{CMS papers, compare exclusion}

\TODO{sr2 int high figure}


% 2/3l, older 2l context
% update with run 2
% multi-bin fit
% orthogonal regions
