...
\TODO{why leading two jets mjj / rjj}
...
A high-level summary of the region design is shown
...
scoop up nearby rare of mismeasured events.
...
splits at $\rjj = 0.8$, to form SR-High-8 and SR-High-16, and second at
...
As always, validation regions are defined near to each signal region, under
...
Various validation studies which explored similar selections and different
simulated samples found no clear explanation for this effect.
...
and~\ref{fig:2ljets_high_mjj_vrhigh}, both VR-High and VR-High-R otherwise show
...
The distribution of mono-jet masses $\mjetone$ is sharply speaked towards zero,
so cutting this out while inveritng the $\mjetone$ selection of SR-High-1J
more clealrly inspects the modelling of massive jets, which appears to be good.
...
the only appropriate caldidate to change for VR-$\llbb$.
...
been advisable.
``In the end'', one \atlas\ author comments,
