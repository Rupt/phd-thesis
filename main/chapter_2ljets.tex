...
In Low regions, $\metsig \in 6\textrm{--}12$, $\zjets$ becomes a large
background contribution, since its fake $\met$, which arises from
from mismeasurements or rare interactions, is no longer eliminated.
Selections inherited from Intermediate regions to suppress
$\ttbar$ backgrounds also need supplementing.
