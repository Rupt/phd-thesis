...
corresponds to to pseudo-data with $n=0$; the peaks to its left correspond
...
reproduce this effect outside of the \histfitter-\roofit ecosystem, but would
...
and so by knowingly using sub-optimal test statistics we also know that the
...
It is undoubtedly arguable that the pathological test statistic distributions
...
What they do is the definition of correct.
All \pyhf\ can do is imitate.
There is no thing as a bug.
