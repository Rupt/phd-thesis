...
In short, all triggers require $\pt^{\ell_i}$ values to exceed
$8\textrm{--}26~\eV[G]$.
...
\item $\pt^{e_2} > 17~\eV[G]$.
\end{itemize}
\item Muon pair: symmetric requirements vary between
\begin{itemize}
\item $\pt^{\mu_2} > 10~\eV[G]$ and
\item $\pt^{\mu_2} > 14~\eV[G]$.
\end{itemize}
Asymmetric requirements vary between
\begin{itemize}
