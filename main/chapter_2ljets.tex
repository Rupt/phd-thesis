...
quality and isolation requirements, details of which can be found in the
...
Like leptons, jets are identified with `baseline' and `signal' requirements
with increasingly tight requirements on quality metrics and kinematics.

\TODO{anti-kt 0.4}

Baseline jets require $\pt > 20~\eV[G]$, and signal jets require
$\pt > 30~\eV[G]$.
