...
sample weights.
Those Matrix Method variations are coupled between bins, meaning that the
...
The figure in (a) was included in an early draft of the paper as evidence to
the quality of the Matrix Method fake/non-prompt estimate.
On the decision of our editorial board, it was removed after validation studies
showed that adding an additional $50\%$ uncertainty to fake/non-prompt yields
made an insignificant difference to the results.
This variation was coupled between all bins.
Differences were assessed by the resulting change in exclusion contours,
which mostly moved by less than their plotted line width.
}
