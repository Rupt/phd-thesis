...
As motivated in the previous sections, I have personal tastes for how searches
...
\subsection{\texorpdfstring{$\met$ significance}{Etmiss significance}}
...
The basic motivation for this design is displayed in
Figure~\ref{fig:2ljets_presel_met};
