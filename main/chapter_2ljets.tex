...
this thesis.
This section briefly lists some of the remaining variations.
...
\paragraph{Alternative rare top} Variations in rare top processes, which matter for SR-$\llbb$, use
...
$70\%$ of the rare top background, so their relative variations are evaluated
and scaled to the total rare top yield.

The central $t\bar{t}Z$ sample uses \amcatnlo+\pythia8, and it is compared
against \pythia~2.2.1 and \amcatnlo+\herwig7 simulations, each of which
