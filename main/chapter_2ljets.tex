...
decided that $\twoljets$-electroweak should chime in to the off-shell
conversation.
...
The $W$ must also be off shell, the softer hadronic activity from light $W^*$
events is not reliably reconstructed as signal jets.
...
the bins vary with their mass splittings.
...
region, and the $\mttwoll \in 80\textrm{--}100\,\eV[G]$ nicely forms a the
...
The control region CR-DY (named after Drell and Yan) is defined to normalize off-shell $\zyjets$ near to
SR-OffShell.
