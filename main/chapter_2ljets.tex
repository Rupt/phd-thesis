...
\end{itemize}
\end{itemize}
Please do not read these all in detail.
The point of listing them is that trigger activations are not trivial,
and motivate lepton selections which exceed these trigger thresholds
to avoid trigger activation effects.
