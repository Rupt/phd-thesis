...
\subsubsection{\texorpdfstring{$\ell\ell bb$}{\textit{llbb}}}
...
\caption{%
\TODO{caption}
\TODO{version with sr filled in, conspicuous dip at W mass}
}
...
\caption{%
Evaluation of candidate High discovery regions.
The region SR-$\ell\ell bb$, labelled `SRllbb' here, is chosen for
