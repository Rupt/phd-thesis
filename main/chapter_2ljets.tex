...
$\njet \geq 1$
\\[.5em]
same flavour, opposite charge $\ell^+\ell^-$
\\[.5em]
$p_\mathrm{T}^{\,\ell_2} > 25\,\eV[G]$
\\[.5em]
$\met > 100\,\eV[G]$
\\[.5em]
$\metsig > 6$
...
\\[1em]
Common: Preselection,
$\mll \in 71\textrm{--}111\,\eV[G]$, $\mttwo > 80\,\eV[G]$.
\caption{%
...
\\[1em]
Common: Preselection,
$\mll \in 81\textrm{--}101\,\eV[G]$, $\mttwo > 80\,\eV[G]$.
\caption{%
% Overview of the High and Intermediate signal, control, and validations regions of the electroweak search.
%All regions except VR-SS require exactly two opposite-charge, same-flavour signal leptons with $\pt>25$~\eV[G]\ and $\met>100~\eV[G]$.
%Instead, VR-SS requires same-charge leptons.
...
\\[1em]
Common: Preselection,
$\njet = 2$, $\nbtag = 0$, $\mll \in 81\textrm{--}101\,\eV[G]$.
\caption{%
% Overview of the High and Intermediate signal, control, and validations regions of the electroweak search.
%All regions except VR-SS-EWK require exactly two opposite-charge, same-flavour signal leptons with $\pt>25$~\GeV\ and $\met>100~\GeV$.
%Instead, VR-SS-EWK requires same-charge leptons.
% The main requirements that distinguish the control and validation regions from the signal regions are highlighted in boldface.
% The bracketed requirements denote the binning used in model-dependent fits, as described in the text.
Differences between regions are \uwave{underlined}.
\TODO{caption}
