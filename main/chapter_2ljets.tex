...
With the tighter selections inherited from Intermediate space, $\ttbar$ yields
remain small in Low regions, which have $\metsig \in 6\textrm{--}12$.
Down here, however, $\zjets$ backgrounds become large, as their fake $\met$
from mismeasured jets is no longer eliminated.

\TODO{read int again, remind myself why some of these decisions are made}
