...
yields outside of the mass window.
...
regions to catch those signal events which fall outside of the primary
$\mjj$ window.
...
yields from some of the lighter signal models.
...
VR-Intm and is seen from Figure~\ref{fig:2ljets_int_region} to retain most
...
Both control regions show good pre-fit agreement with statistical uncertainties
only.
