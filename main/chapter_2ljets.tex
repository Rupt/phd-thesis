...
ATLFAST-II~\cite{SOFT-2010-01} that uses approximate descriptions of the
...
required validation of these ATLFAST-II mass distributions.
...
is also unusual.
% TODO citations for large-R jet searches
