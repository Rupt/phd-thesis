...
My main result in this thesis is displayed in Figure~\ref{fig:2ljets_summary}.

It shows unblinded regions from the electroweak part of
Reference~\cite{atlas2022searches}, which reports searches
``for new phenomena in events with two leptons, jets, and missing
transverse momentum''.
For brevity, I will name that search $\twoljets$.

This section begins with a splash summary of interpretations of the results in
Figure~\ref{fig:2ljets_summary},
before cutting through the gory details later on.

In a large number orthogonal signal regions, where non-standard signals would
encourage excess data above backgrounds,
no significant excess is observed above \emph{post-fit} background expectations.
...
$139~\mathrm{fb}^{-1}$ of usable proton-proton collisions at a collision energy
of $13~\eV[T]$.
...
of which all three parts expand upon \atlas\ results which previously appeared
...
orthogonal regions in a search for effects from the electroweak sector of
supersymmetric models.

Unsurprisingly, the strong part of the $\twoljets$ analysis,
detailed in Section~\ref{sec:2ljets_origins_strong},
searches for effects from the strong sector.
It also uses conventional event variables and with an emphasis on the mass
spectrum of lepton pairs.
...
In this way, RJR variables attain intelligence in how parent particles are
reconstructed from their visible decay products and approximate independence
from uninteresting boosts, particularly those from the emission of QCD jets
outside of the supersymmetric decay tree.

Over the last several years, RJR event variables have been demonstrated as
effective tools for interpreting supersymmetric particle physics
data~\cite{santoni2018probing},
have been used in numerous \atlas\ analyses~\cite{%
atlas_rjr_SUSY_2016_07,
atlas_rjr_SUSY_2016_15,
atlas_rjr_SUSY_2016_16,
atlas_rjr_23l_SUSY_2017_03
}, and have influenced the designs of other
analyses~\cite{atlas_rjr_mimic_SUSY_2018_06}.


Decay trees used in the $\twoljets$ RJR analysis,
which displayed in Figure~\ref{fig:2ljets_rjr_decay_tres},
