...
the inner detector in Section~\ref{sec:atlas_inner},
...
\footnotetext{%
This footnote, which was perfected in~\cite{lester2013heffalon},
``should be used in every \atlas\ publication''~\cite{atlas_footnote}.
True to form, internal \atlas\ guidelines ask that
``If you think you can improve on it, please consult with the
Publications Committee''~\cite{atlas_coordinate}.
We somehow added the sentence defining angular distance without such a
consultation.%
}
