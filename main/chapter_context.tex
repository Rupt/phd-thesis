...
experiment, and alongside its biggest neighbours
...
\atlas' design and calibration achieves a high precision that increases to
only $10\%$ relative error on tracks with $1\,\eV[T]$ transverse momenta~\cite{
atlas1994proposal,
atlas2008experiment,
...
\TODO{trigger~\cite{atlas2016trigger}}
% 25ns bunch spacing
\TODO{
With $25\,\mathrm{ns}$ bunch spacing and \atlas' $12.5\,\textrm{m}$ radius,
light-speed particles ejected from one crossing are still zipping through
\atlas\ when the next collision arrives.
}
% fast decisions to not overflow buffer queue
\begin{quote}
``%
