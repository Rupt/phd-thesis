...
This extreme engineering is necessary to achieve the luminosities we
...
% process into event variables
% clean for conditions?
% describe LHC Run 1 and Run 2
...
\TODO{
data quality; ignore defects, maximize the uniformity of detector
operations~\cite{
DAPR-2018-01,
Golling:2011zy
}
...
\TODO{performance and calibration?}

\TODO{LHC runs; run 1, run 2}
