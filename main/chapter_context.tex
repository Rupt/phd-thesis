...
Theory is needed to understand experimental data,
...
The Standard Model is science's best current understanding of Nature's
fundamental objects in their observable behaviours as particles.
It has solid mathematical foundations, and accurately describes the
physics of particle interactions across a very broad domain.
...
experimental fronts.
We describe the current Standard Model, its limitations and possible future
directions in Section~\ref{sec:context_sm}.
...
\subsubsection{Future Standard Models}
...
Raw binary data are hard to interpret.
...
alternatives,
and interpretable data, from \atlas' measurements of LHC collisions,
