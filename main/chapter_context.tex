...
The \atlas\ detector did not assemble itself into a preordained form.
It results from a large collaborative effort towards a design that would
provide maximally useful and novel data
without exceeding real-world budgets in construction or operation.
...
$m_H \gtrsim 90\,\eV[G]$ from direct searches at the
...
and \atlas' designers achieved discovery sensitivity across the entire
$m_H \in 100\textrm{--}1000\,\eV[G]$
window by targetting decays including
$H\to b\bar b$,
$H\to \gamma\gamma$,
$H\to ZZ^* \to 4\ell$, and
$H\to ZZ \to \ell\ell\nu\nu$.
This spectrum demands precise measurements of leptons, photons, and
...
% Famously, \atlas\ and \cms\ have since found a Higgs boson candidate at
% $m_H = 125\,\eV[G]$~\cite{
% }
% with all of its predicted Standard Model properties~\cite{
% }.

\paragraph{Precise measurements of known objects.}
