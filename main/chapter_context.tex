...
In this model, gluons correspond to the eight generators of $SU\!(3)_C$, whose
subscript $_C$ indicates that they operate on colour-charge triplets of quarks.
Weak and electromagnetic forces are also unified into electroweak interactions
with four bosons $W^1$, $W^2$, $W^3$, and $B$ from the
...
mass to be below $\lesssim 130\,\eV[G]$ long before its observation at
$125\,\eV[G]$~\cite{
espinosa1992higgs,
espinosa1993upper,
...
supersymmetry remains a useful tool for building theoretically plausible
