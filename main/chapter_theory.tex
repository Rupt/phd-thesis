...
the top quark mass is slightly \emph{uncertain}, but
...
Gravitational mechanism exist, but one model considered in this thesis uses
...
Conservation of $R$-parity usefully preventing proton decays,
