...
\begin{abstract}
\TODO{searches for new effects in atlas are a core reason for its operations}

\TODO{this thesis presents such a search~\cite{atlas2022searches}}

\TODO{after briefly introducing its theoretical and experimental context}

\TODO{For given modelling of theory and experiment,
data analysis procedures dominate, and they take a very particular form
which we attempt to understand in its historical context
}

\TODO{
The result is compatible with many other observations,
that the Standard Model works very well at the LHC.
}

\TODO{To explain this title...}
\TODO{supersymmetry is not falsifiable?}
