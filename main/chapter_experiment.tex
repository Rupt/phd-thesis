...
jets.
\TODO{and missing transverse momentum},
this section reviews \atlas's experimental resolution for these objects.
...
particles that scales in proportion to the electron energy $E$.
...
In \atlas, these $a_i$ parameters are roughly
...
reproduces the reported resolutions of
$\frac{\sigma(E)}{E} \approx 4\%$ at $E = \pt = 10\,\eV[G]$,
$\frac{\sigma(E)}{E} \approx 1\%$ at $E = \pt = 100\,\eV[G]$, and
$\frac{\sigma(E)}{E} \approx 0.1\%$ at
$E = \pt = 1\,\eV[T]$ for electrons~\cite{atlas2019electron}.
...
\end{equation}
with
$b_1 \approx 0.5\,\sqrt{\eV[G]}$ and
$b_2 \approx 0.03$.

\paragraph{Missing transverse momentum.}
\TODO{}
% Reference from Holly
%  ATLAS collaboration. ET
% miss performance in the ATLAS detector using 2015–2016 LHC
% pp collisions. ATLAS-CONF-2018-023, 2016.
