...
For all of our data, we are therefore indebted to the LHC for so reliably
providing these exciting particle interactions.
...
Figure~\ref{fig:atlas_cern_complex}

\begin{figure}[tp]
\centering
\includegraphics[width=0.98\textwidth]{figures/atlas_lhc_complex.png}
\caption[
...
\label{fig:atlas_cern_complex}
\end{figure}

% the accelerator complex
% RF cavities
% magnets (dipole, quadrupole etc)
% size of beam
