...
\TODO{expected loss: risk}
minimize the expected risk~\cite{
wald1947bayes,
wald1950bayes,
jaynes2003probability
}
...
,
\end{equation}
for some cost function $c(t, x)$ for decisions $t$ and states of the world
$x$ that have prior probabilities $p(x)$.
Although alternative ideas (such as minimax, minimizing a maximum
loss~\cite{savage1951review}) may empirically work well, this theory finds that
restricting oneself to Bayes decision rules cannot deny access to optimal
decisions.
