...
Such assignments are must be normalized, but might be loosely informed informed
...
derivative is negative, so to leading order a product of $f$s looks like
\begin{equation}
f(x)^N =
\lim_{N \to \infty}\!
\left(
...
Another more beautiful proof of the Central Limit Theorem is given by
...
This theory does not define how to construct that cost function.
