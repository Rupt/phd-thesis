...
exceeds thresholds, similar to Fisher's likelihood intervals.
...
\TODO{
toy procedure;
not true $p$-value because it pre-fits;
alternative approximation to asymptotics; not necessarily better;
choose your poison}
