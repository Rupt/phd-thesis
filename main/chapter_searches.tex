...
$\prob{t \geq t(d)}{h}$, but a depends on some function of the data
...
this makes a deficit in data appear much less significant that it should.

Nonetheless, this procedure often simulates reasonable-looking test statistic
distributions without relying on the asymptotic approximations.
