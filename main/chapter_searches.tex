...
\begin{equation}
t = (\bar{\mu} - \mu)\sqrt{\frac{n}{\bar{\sigma}^2}}
,
\end{equation}
where $\mu$ is the known data mean, and $\bar{\mu}$ and $\bar{\sigma}^2$ are
standard estimates of the mean and variance of the data sample respectively.
By dividing out a standard deviation, $t$ is independent of any common
scale factors on the data~\cite{student1908, fisher1925t, lehmann2011fisher}.
...
% p-values
\TODO[
(probable error?), known in modern jargon as $p$-values
