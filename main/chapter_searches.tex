...
algebra.
All influence from data is conducted through the likelihood function
\TODO{here state how we should use this}.

The infamy of Bayes' rule stems from a fixation on the posterior distributions
from unjustified prior assignments, which has been present since its earliest
classical developments by Bayes and
Laplace~\cite{bayes1763lii, laplace1774stigler}.
Both Bayes and Laplace assume prior densities that are uniform in their chosen
coordinates, a practice that is fairly criticized as arbitrary
