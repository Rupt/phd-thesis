...
Equation~\ref{eqn:searches_prob_ratio}, and comprises the \textbf{product rule}
\begin{align}
...
\end{align}
for combinations in a union, with sums over exhaustive sets outcomes
...
Data on top are ordered with $n$ from left to right, and data on the bottom are
reordered to have increasing values of the test statistic $-\Lambda(n)$.
}
\end{subfigure}
\\[.5em]
\begin{subfigure}{\textwidth}
...
either side.
Ultimately, the reader may distrust the reporter ---
the statements
