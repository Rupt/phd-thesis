...
simply inaccurate for a 20th century innovation created to replace 18th century
...
However, the hard rejection of priors on hypotheses also prevents calculation
of evidence values, without which likelihoods can become confounded
in too many parameters (perhaps making them nuisances).
...
% test statistics
A test statistic is a function of data.
All real-valued functions are permitted, but some are more useful than others.
\TODO{TODO t-statistic}
