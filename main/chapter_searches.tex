...
do not challenge the hypotheses that assign their priors $\pi(x) \prob{x}{h}$.
Since the evidence is a likelihood function over hypotheses, it can challenge
them by comparing how well they predicted data.
