...
Together these do not form a harmonious framework;
the two groups have emphatic disagreements in print, but together they
do cover many practices that survive in modern science and explain important
features of the methods we apply to LHC data, which will be introduced in
Section~\ref{sec:searches_practice}.
