...
Furthermore, it actively harms any result with small a test statistic by
...
\end{equation}
then large tail probabilities will only squash the $\log$ likelihood ratio
toward zero.
