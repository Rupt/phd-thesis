...
Misinterpretations of \pvalues\ are widespread and well reported~\cite{
schervish1996p,
Cohen1994TheEI,
Amrhein2017TheEI,
goodman2008dirty,
...
plausibly explained by vague but accurate statements like
``compatible with the SM prediction with a $P$ value of $0.10\%$''~\cite{
lhcb2021test
}
mutating to precise and inaccurate statements like
...
All that matters to the interpretation is that an alternative hypothesis makes
