...
or by obfuscating those statistics with bias corrections.
...
are largely explained by the linguistic trickery in its naming --- our
results should not be biased by forces outside the data and relevant theory,
and we would love to claim that to be true.
...
as for all other likelihoods, small values are only meaningful in comparison
against larger values from alternative hypotheses.
