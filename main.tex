...
% \documentclass[nobind,draft,oneside]{hepthesis_tombs}
%\documentclass[nobind,draft,twoside]{hepthesis}

%% For short draft builds (breaks citations by necessity)
%\documentclass[nobind,draft,hidefrontback]{hepthesis}

%%For Cambridge soft-bound version
\documentclass[bindnopdf]{hepthesis_tombs}
